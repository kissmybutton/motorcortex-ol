...
/** @class */
function (_super) {
  __extends$W(AssertionError, _super);
  /**
...
var shared$4 = new IconImageCache();
...
/** @class */
function (_super) {
  __extends$T(ObjectEvent, _super);
  /**
...
/** @class */
function (_super) {
  __extends$P(RenderEvent, _super);
  /**
...
/** @class */
function (_super) {
  __extends$O(CompositeMapRenderer, _super);
  /**
   * @param {import("../PluggableMap.js").default} map Map.
   */
  ...
  CompositeMapRenderer.prototype.dispatchRenderEvent = function (type, frameState) {
    ...
    if (map.hasListener(type)) {
      var event_1 = new RenderEvent$1(type, undefined, frameState);
...
/** @class */
function (_super) {
  __extends$N(CollectionEvent, _super);
  /**
  ...
  function LayerGroup(opt_options) {
    ...
    if (layers) {
      if (Array.isArray(layers)) {
        layers = new Collection$1(layers.slice(), {
          unique: true
        });
      } else {
        assert(typeof
      ...
      layers = new Collection$1(undefined, {
        unique: true
      });
    }
...
/** @class */
function (_super) {
  __extends$J(MapBrowserEventHandler, _super);
  /**
  ...
  MapBrowserEventHandler.prototype.emulateClick_ = function (pointerEvent) {
    ...
    if (this.clickTimeoutId_ !== undefined) {
      ...
      function () {
        this.clickTimeoutId_ = undefined;
        var newEvent = new MapBrowserEvent$1(MapBrowserEventType.SINGLECLICK, this.map_, pointerEvent);
        this.dispatchEvent(newEvent);
      }.bind(this), 250);
    }
  };
...
var METERS_PER_UNIT$1 = {}; // use the radius of the Normal sphere
...
/** @class */
function (_super) {
  __extends$H(EPSG3857Projection, _super);
  /**
...
/** @class */
function (_super) {
  __extends$G(EPSG4326Projection, _super);
  /**
   * @param {string} code Code.
...
var PROJECTIONS = [new EPSG4326Projection('CRS:84'), new EPSG4326Projection('EPSG:4326', 'neu'), new EPSG4326Projection('urn:ogc:def:crs:OGC:1.3:CRS84'), new EPSG4326Projection('urn:ogc:def:crs:OGC:2:84'), new EPSG4326Projection('http://www.opengis.net/def/crs/OGC/1.3/CRS84', 'neu'), new EPSG4326Projection('http://www.opengis.net/gml/srs/epsg.xml#4326', 'neu'), new EPSG4326Projection('http://www.opengis.net/def/crs/EPSG/0/4326', 'neu')];
...
/** @class */
function (_super) {
  __extends$E(SimpleGeometry, _super);
...
function (_super) {
  ...
  Polygon.prototype.getLinearRings = function () {
    ...
    for (var i = 0, ii = ends.length; i < ii; ++i) {
      var end = ends[i];
      var linearRing = new LinearRing$1(flatCoordinates.slice(offset, end), layout);
...
function createResolutionConstraint(options) {
  ...
  if (options.resolutions !== undefined) {
    ...
    360 * METERS_PER_UNIT$1[Units$1.DEGREES] / projection.getMetersPerUnit() : Math.max(getWidth(projExtent), getHeight(projExtent));
...
/** @class */
function (_super) {
  __extends$z(PluggableMap, _super);
  /**
...
function createOptionsInternal(options) {
  ...
  /** @type {LayerGroup} */
  options.layers : new LayerGroup$1({
    layers:
    /** @type {Collection} */
    options.layers
  });
...
/** @class */
function (_super) {
  __extends$x(Attribution, _super);
  /**
...
/** @class */
function (_super) {
  __extends$o(DragBoxEvent, _super);
  /**
   * @param {string} type The event type.
...
/** @class */
function (_super) {
  __extends$m(KeyboardPan, _super);
  /**
   * @param {Options} [opt_options] Options.
   */
...
/** @class */
function (_super) {
  __extends$l(KeyboardZoom, _super);
  /**
   * @param {Options} [opt_options] Options.
   */
...
/** @class */
function (_super) {
  __extends$j(PinchRotate, _super);
  /**
   * @param {Options} [opt_options] Options.
   */
...
/** @class */
(function (_super) {
  __extends$e(ImageWrapper, _super);
  /**
   * @param {import("./extent.js").Extent} extent Extent.
   * @param {number|undefined} resolution Resolution.
   * @param {number} pixelRatio Pixel ratio.
...
function defaults(opt_options) {
  ...
  var kinetic = new Kinetic$1(-0.005, 0.05, 100);
...
function (_super) {
  ...
  CanvasTileLayerRenderer.prototype.renderFrame = function (frameState, target) {
    ...
    var canvasTransform = toString$5(this.pixelTransform);
...
function (_super) {
  ...
  function TileImage(options) {
    ...
    _this.tileClass = options.tileClass !== undefined ? options.tileClass : ImageTile$1;
    /**
     * @protected
  ...
  TileImage.prototype.getTile = function (z, x, y, pixelRatio, projection) {
    ...
    if (!ENABLE_RASTER_REPROJECTION || !sourceProjection || !projection || equivalent(sourceProjection, projection)) {
      ...
      if (tile && tile.key == key) {
        ...
        var newTile = new ReprojTile$1(sourceProjection, sourceTileGrid, projection, targetTileGrid, tileCoord, wrappedTileCoord, this.getTilePixelRatio(pixelRatio), this.getGutter(), function (z, x, y, pixelRatio) {
...
var olMap = /*#__PURE__*/function (_MC$BrowserClip) {
...
var fails = fails$6; // check the existence of a method, lowercase
...
var forcedStringHTMLMethod = stringHtmlForced; // `String.prototype.anchor` method
...
var ZoomTo = /*#__PURE__*/function (_MC$Effect) {
