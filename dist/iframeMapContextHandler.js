...
*/
var MC = require("@kissmybutton/motorcortex"); // const MC = require('../motorcortex');
// console.log(MC);
// const Helper = MC.Helper;


var helper = new MC.Helper(); // const Group = MC.Group;
// const conf = MC.conf;

var Iframe3DContextHandler =
/*#__PURE__*/
function () {
  /**
  ...
  _createClass(Iframe3DContextHandler, [{
    ...
    /*selector*/
    {
      return [this.context.mapRef]; // const elements = [];
      // let key = "groups";
    ...
    /*mcid*/
    {
      return this.context.mapRef; // // console.log("in get selector",mcid)
      // for (const prop in this.context.elements) {
      //   for (const element in this.context.elements[prop]) {
